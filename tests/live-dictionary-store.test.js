...
const entry = { t: "mały dom", d: { s: "A small home.", t: "Niewielki dom." }, s: ["cottage"],
...
test("language pairs and case stay isolated; old cached packs are ignored", async () => {
    ...
    assert.equal(new Set(env.calls).size, 4);
});

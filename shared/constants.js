...
(function initConstants(root, factory) {
    ...
    function createConstants() {
        ...
        const UI_CLASSES = Object.freeze({
            ...
            SUBTITLES_LAYER: `${PREFIX}subtitles-layer`,
            SUBTITLES_BOX: `${PREFIX}subtitles-box`,
            SUB_LINE: `${PREFIX}sub-line`,
            SUB_SECONDARY: `${PREFIX}sub-secondary`,
            SUB_TRANSLATION: `${PREFIX}sub-translation`,
            SUB_HANDLE: `${PREFIX}subtitles-drag-handle`,
            SUB_DRAGGING: `${PREFIX}is-dragging`,
            CUSTOM_SUBTITLES_LAYER: `${PREFIX}subtitles-layer`,
            CUSTOM_SUBTITLES_BOX: `${PREFIX}subtitles-box`,
            CUSTOM_SUB_TRANSLATION: `${PREFIX}sub-translation`,
            CUSTOM_SUB_SECONDARY: `${PREFIX}sub-secondary`,

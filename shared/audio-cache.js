            ...
            async findByText(text, { notBefore = 0 } = {}) {
                try {
                    ...
                    if (newest) {
                        ...
                        if (blob)
                            return { blob, voiceId: newest.voiceId || "" };
                    }
                    ...
                    console.error(
                        "[Lectoro] AudioCache findByText error:",
                        err,
                    );
                    return null;
                }

...
(function initQuizExport(root) {
    ...
    const QUIZ_I18N = {
        ko: {
            ...
            "goodLuck": "행운을 빕니다!",
            "wordsCount": "단어",
            "printBtn": "🖨️ 인쇄/PDF로 저장",
            "checkAllBtn": "✅ 모든 답변 확인 및 점수 확인",
            "resetBtn": "🔄 재설정하고 다시 시도하세요",
            "answered": "답변됨",
            "streak": "연속",
            "streakInRow": "연속으로!",
            "yourAnswerPlaceholder": "당신의 대답은… (Enter = 체크)",
            "hint": "힌트",
            "trueLabel": "참",
            "falseLabel": "거짓",
            "selectPlaceholder": "— 선택 —",
            "correctLabel": "정답",
            "noAnswer": "제공된 답변이 없습니다.",
            "similarity": "유사성",
            "passed": "합격",
            "result": "결과",
            "pointsSuffix": "포인트",
            "listenLabel": "큰 소리로 듣기",
            "dontKnow": "기억나지 않아요",
            "reviewTitle": "틀린 문제 복습",
            "reviewInstructions": "틀린 단어는 몇 문제 뒤에 다시 나옵니다. 힌트 없이 정답을 맞혀 기억을 강화하세요.",
            "masteryTitle": "어휘 학습 현황",
            "masteryMastered": "완전히 익힘",
            "masteryAlmost": "거의 익힘",
            "masteryLearning": "학습 중",
            "masteryWeak": "학습 필요",
            "reviewReady": "복습할 시간",
            "recallInstructions": "선택지 없이 단어나 표현을 기억해서 입력하세요.",
            "contextRecallInstructions": "빈칸에 들어갈 단어나 표현을 기억해 보세요. 틀린 문제는 나중에 다시 나옵니다.",
            "matchingInstructions": "단어와 뜻을 연결하며 기억해서 답하는 연습을 준비하세요.",
            "choiceInstructions": "알맞은 단어를 고르세요. 이 연습은 직접 답을 입력하는 문제보다 배점이 낮습니다.",
            "praise": [
                "훌륭한! 🎉",
                "정말 잘했어요! 👏",
                "굉장해요! ⭐",
            ...
            "sectionTitles": {
                "multiple_choice": "객관식",
                "recall": "기억해서 답하기",
                "context_recall": "문맥에서 기억하기",
                "matching": "짝 맞추기",
                "true_false": "참 또는 거짓",
                "correct_form": "올바른 단어 형식",
                "odd_one_out": "홀수 하나 아웃"
            },
            "examTitlePrefix": "어휘 시험",
            "defaultTitle": "어휘 퀴즈",
            "name": "성명",
            "class": "수업/그룹",
            "date": "날짜",
        ...
        es: {
            masteryWeak: "Por aprender",
            reviewReady: "Es hora de repasar",
            recallInstructions: "Escribe la palabra o expresión de memoria, sin opciones de respuesta.",
            contextRecallInstructions: "Recuerda la palabra o expresión que falta. Los errores volverán más adelante.",
            matchingInstructions: "Relaciona las palabras con su significado como preparación para recordarlas de memoria.",
            choiceInstructions: "Elige la palabra correcta. Este ejercicio cuenta menos que escribir la respuesta de memoria.",
            dontKnow: "No lo recuerdo",
            reviewTitle: "Repaso de errores",
            reviewInstructions: "Las palabras falladas vuelven tras algunas preguntas. Responde correctamente sin pistas para recordarlas mejor.",
            masteryTitle: "Dominio del vocabulario",
            masteryMastered: "Dominado",
            masteryAlmost: "Casi aprendido",
            masteryLearning: "En aprendizaje",
        ...
        de: {
            masteryWeak: "Noch zu lernen",
            reviewReady: "Zeit zum Wiederholen",
            recallInstructions: "Gib das Wort oder den Ausdruck aus dem Gedächtnis ein. Es gibt keine Antwortauswahl.",
            contextRecallInstructions: "Ergänze das fehlende Wort oder den Ausdruck aus dem Gedächtnis. Fehler werden später wiederholt.",
            matchingInstructions: "Ordne die Wörter ihren Bedeutungen zu. Das ist eine kurze Vorbereitung auf das freie Erinnern.",
            choiceInstructions: "Wähle das richtige Wort. Diese Übung zählt weniger als das selbstständige Eingeben der Antwort.",
            dontKnow: "Ich weiß es nicht",
            reviewTitle: "Fehler wiederholen",
            reviewInstructions: "Falsch beantwortete Wörter erscheinen nach einigen Fragen erneut. Antworte ohne Hinweise richtig, um sie zu festigen.",
            masteryTitle: "Wortschatzfortschritt",
            masteryMastered: "Beherrscht",
            masteryAlmost: "Fast gelernt",
            masteryLearning: "In Bearbeitung",
        ...
        fr: {
            dontKnow: "Je ne me souviens pas",
            reviewTitle: "Révision des erreurs",
            reviewInstructions: "Les mots manqués reviennent après quelques questions. Réponds correctement sans indice pour mieux les mémoriser.",
            masteryTitle: "Maîtrise du vocabulaire",
            masteryMastered: "Acquis",
            masteryAlmost: "Presque acquis",
            masteryLearning: "En cours d’apprentissage",
            masteryWeak: "À apprendre",
            reviewReady: "À réviser",
            recallInstructions: "Écris le mot ou l’expression de mémoire, sans choix de réponse.",
            contextRecallInstructions: "Retrouve le mot ou l’expression manquant de mémoire. Les erreurs reviendront plus tard.",
            matchingInstructions: "Associe les mots à leur sens pour te préparer au rappel de mémoire.",
            choiceInstructions: "Choisis le bon mot. Cet exercice compte moins que les réponses écrites de mémoire.",
        ...
        it: {
            masteryWeak: "Da imparare",
            reviewReady: "È ora di ripassare",
            recallInstructions: "Scrivi la parola o l’espressione a memoria, senza opzioni di risposta.",
            contextRecallInstructions: "Ricorda la parola o l’espressione mancante. Gli errori torneranno più avanti.",
            matchingInstructions: "Abbina le parole ai significati per prepararti a ricordarle a memoria.",
            choiceInstructions: "Scegli la parola corretta. Questo esercizio conta meno delle risposte scritte a memoria.",
            dontKnow: "Non ricordo",
            reviewTitle: "Ripasso degli errori",
            reviewInstructions: "Le parole sbagliate tornano dopo alcune domande. Rispondi correttamente senza suggerimenti per ricordarle meglio.",
            masteryTitle: "Padronanza del vocabolario",
            masteryMastered: "Imparato",
            masteryAlmost: "Quasi imparato",
        ...
        pt: {
            masteryWeak: "A aprender",
            reviewReady: "Hora de revisar",
            recallInstructions: "Digite a palavra ou expressão de memória, sem alternativas de resposta.",
            contextRecallInstructions: "Lembre a palavra ou expressão que falta. Os erros voltarão mais tarde.",
            matchingInstructions: "Associe as palavras aos significados para se preparar para lembrar de memória.",
            choiceInstructions: "Escolha a palavra correta. Este exercício vale menos do que escrever a resposta de memória.",
            dontKnow: "Não me lembro",
            reviewTitle: "Revisão dos erros",
            reviewInstructions: "As palavras erradas voltam após algumas perguntas. Acerte sem dicas para memorizá-las melhor.",
            masteryTitle: "Domínio do vocabulário",
            masteryMastered: "Dominado",
            masteryAlmost: "Quase aprendido",
            masteryLearning: "Em aprendizagem",
        ...
        nl: {
            masteryWeak: "Nog te leren",
            reviewReady: "Tijd om te herhalen",
            recallInstructions: "Typ het woord of de uitdrukking uit je hoofd, zonder antwoordopties.",
            contextRecallInstructions: "Vul het ontbrekende woord of de uitdrukking uit je hoofd in. Fouten komen later terug.",
            matchingInstructions: "Koppel woorden aan hun betekenis als voorbereiding op het uit je hoofd antwoorden.",
            choiceInstructions: "Kies het juiste woord. Deze oefening telt minder zwaar dan zelf het antwoord typen.",
            dontKnow: "Ik weet het niet meer",
            reviewTitle: "Fouten herhalen",
            reviewInstructions: "Fout beantwoorde woorden komen na een paar vragen terug. Antwoord goed zonder hints om ze beter te onthouden.",
            masteryTitle: "Woordenschatbeheersing",
            masteryMastered: "Beheerst",
            masteryAlmost: "Bijna geleerd",
            masteryLearning: "Aan het leren",
        ...
        cs: {
            masteryWeak: "K naučení",
            reviewReady: "Čas na opakování",
            recallInstructions: "Napiš slovo nebo výraz zpaměti, bez výběru odpovědí.",
            contextRecallInstructions: "Doplň chybějící slovo nebo výraz zpaměti. Chybné odpovědi se později vrátí.",
            matchingInstructions: "Přiřaď slova k významům jako přípravu na vybavování zpaměti.",
            choiceInstructions: "Vyber správné slovo. Toto cvičení má menší váhu než vlastní napsání odpovědi.",
            dontKnow: "Nepamatuji si",
            reviewTitle: "Opakování chyb",
            reviewInstructions: "Chybně zodpovězená slova se po několika otázkách vrátí. Odpověz správně bez nápovědy, aby sis je lépe zapamatoval.",
            masteryTitle: "Znalost slovíček",
            masteryMastered: "Zvládnuto",
            masteryAlmost: "Téměř zvládnuto",
            masteryLearning: "Učím se",
        ...
        ja: {
            masteryWeak: "これから学習",
            reviewReady: "復習の時間",
            recallInstructions: "選択肢を見ずに、単語や表現を思い出して入力してください。",
            contextRecallInstructions: "空欄に入る単語や表現を思い出してください。間違えた問題は後でもう一度出題されます。",
            matchingInstructions: "単語と意味を組み合わせて、思い出す練習の準備をしましょう。",
            choiceInstructions: "正しい単語を選んでください。この練習の配点は、自分で答えを入力する問題より低くなっています。",
            dontKnow: "思い出せない",
            reviewTitle: "間違えた問題の復習",
            reviewInstructions: "間違えた単語は数問後に再び出題されます。ヒントなしで正解して記憶を定着させましょう。",
            masteryTitle: "単語の習得状況",
    ...
    function getExamTitle(srcLang, tgtLang) {
        ...
        const srcName = new Intl.DisplayNames([tgt], { type: "language" }).of(src);
        ...
        if (tgt === "ko") return `${srcName} 어휘 시험`;

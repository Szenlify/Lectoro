...
(() => {
    ...
    function buildDictionaryDetailsHtml(dictionary, srcLang, targetLang) {
        ...
        return `<section class="${P}dictionary-details" aria-label="Dictionary details">${definition ? `<div class="${P}dictionary-definition-section"><div class="${P}dictionary-caption">Definition</div>${definition}</div>` : ""}${examples.length ? `<div class="${P}dictionary-caption">Examples</div>` : ""}${examples
            .slice(0, 3)
